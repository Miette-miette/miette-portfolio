                ...
                <div className='flex flex-col justify-center items-center'>
                    ...
                    <div className="bento-pink relative z-1 flex flex-col md:flex-row justify-center items-center m-2 ">
                        ...
                        <div className='m-2'>
                            ...
                            <p>Développer des applications responsives, de la partie Front-end au Back-end, du maquettage d'un site, jusqu'au déploiement de la solution finale. </p>
                        </div> 
                    </div>
                </div>
                 ...
                 <div className='flex flex-col justify-center items-center h-280 -mt-170 '>
                    ...
                    <div className='sticky flex z-0 items-end justify-end w-full top-40 md:top-45 mb-5 p-6 bg-[url(/media/formation-frog/form7.png)] md:bg-[url(/media/formation-frog/form6xs.png)] lg:bg-[url(/media/formation-frog/form6xl.png)] bg-center bg-no-repeat bg-contain '>
                        <div className='text-center flex flex-col justify-center items-center ml-0 md:ml-50 p-6 sm:p-8 mt-10 md:mt-1 md:p-2'>
                            <h2 className=' text-sm md:text-lg text-center text-[#763c48] w-[90%] sm:w-[70%] p-2 sm:p-4 md:p-6'>À l'écoute d'opportunités dans le développement Front-End !</h2>
                            ...
                            <Link href='/media/cv/CV.png' target='_blank' >
                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='w-15 md:w-20'>
                                    ...
                                    <g id="SVGRepo_iconCarrier"> 
                                        <path d="M13 9L15 15L17 9M10 15C9.06812 15 8.60218 15 8.23463 14.8478C7.74458 14.6448 7.35523 14.2554 7.15224 13.7654C7 13.3978 7 12.9319 7 12C7 11.0681 7 10.6022 7.15224 10.2346C7.35523 9.74458 7.74458 9.35523 8.23463 9.15224C8.60218 9 9.06812 9 10 9M7.2 20H16.8C17.9201 20 18.4802 20 18.908 19.782C19.2843 19.5903 19.5903 19.2843 19.782 18.908C20 18.4802 20 17.9201 20 16.8V7.2C20 6.0799 20 5.51984 19.782 5.09202C19.5903 4.71569 19.2843 4.40973 18.908 4.21799C18.4802 4 17.9201 4 16.8 4H7.2C6.0799 4 5.51984 4 5.09202 4.21799C4.71569 4.40973 4.40973 4.71569 4.21799 5.09202C4 5.51984 4 6.07989 4 7.2V16.8C4 17.9201 4 18.4802 4.21799 18.908C4.40973 19.2843 4.71569 19.5903 5.09202 19.782C5.51984 20 6.07989 20 7.2 20Z" stroke="#763c48" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"></path> 
                                    </g>
                                </svg>
                            </Link> 
                        </div>
