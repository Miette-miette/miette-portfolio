...
export default function Domaine() {
    ...
    return(
        <section id='domaine' className='flex justify-center items-center flex-col text-amber-50 relative z-6 bg-[url(/media/backgrounds/domaine_mobile.svg)]  md:bg-[url(../../public/media/backgrounds/domaine_desktop.svg)] bg-top bg-no-repeat bg-cover text-center'>
            <div>
            ...
            <div className='flex flex-col md:flex-row text-[#B36E7B] p-5 pr-10 pl-10 lg:pr-60 lg:pl-60'>
                ...
                <div className='flip-domaine relative z-6 m-2 md:m-4'>
                    <div className='flip-domaine-inner'>
                        ...
                        <div className='back-doodle bento-pink flex flex-col justify-center items-center text-[#FEFAE0]'>
