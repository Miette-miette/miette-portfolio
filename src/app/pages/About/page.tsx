                        ...
                        <div className="flex flex-row justify-center items-center mt-4">
                            ...
                            <a href='www.linkedin.com/in/doriane-le-guyader-3a6b2a1bb'>
                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='w-10'>
                                    <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                                    <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                                    <g id="SVGRepo_iconCarrier"> <path d="M6.5 8C7.32843 8 8 7.32843 8 6.5C8 5.67157 7.32843 5 6.5 5C5.67157 5 5 5.67157 5 6.5C5 7.32843 5.67157 8 6.5 8Z" fill="beige"></path> 
                                    <path d="M5 10C5 9.44772 5.44772 9 6 9H7C7.55228 9 8 9.44771 8 10V18C8 18.5523 7.55228 19 7 19H6C5.44772 19 5 18.5523 5 18V10Z" fill="beige"></path> 
                                    <path d="M11 19H12C12.5523 19 13 18.5523 13 18V13.5C13 12 16 11 16 13V18.0004C16 18.5527 16.4477 19 17 19H18C18.5523 19 19 18.5523 19 18V12C19 10 17.5 9 15.5 9C13.5 9 13 10.5 13 10.5V10C13 9.44771 12.5523 9 12 9H11C10.4477 9 10 9.44772 10 10V18C10 18.5523 10.4477 19 11 19Z" fill="beige"></path> 
            ...
            <section id="skills" className="parcours p-5 pr-5 pl-5 md:pr-70 md:pl-70 flex flex-col overflow-hidden" >
                ...
                <div id="front" className="bento-beige flex flex-col" data-aos="fade-left">
                    ...
                    <div className="flex flex-wrap md:flex-row justify-center items-center "> 
                        ...
                        <div className="bento-green h-30 flex flex-col justify-center items-center m-2">
                            <h4>HTML</h4>
                ...
                <div id="back" className="bento-beige" data-aos="fade-left">
                    ...
                    <div className="flex flex-wrap md:flex-row justify-center items-center">
                        ...
                        <div className="bento-green h-30 flex flex-col justify-center items-center m-2">
                            <h4>Elementor</h4>
                            <svg fill="#FAFBF2" viewBox="0 0 14 14" role="img" focusable="false" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
                            <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                            <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
                            <g id="SVGRepo_iconCarrier">
                ...
                <div id="design" className="bento-beige" data-aos="fade-left">
                    ...
                    <div className="flex flex-wrap md:flex-row justify-center items-center m-2">
                        <div className="bento-green flex flex-col justify-center items-center m-2">
                            <h4>Figma</h4>
                            <svg className="icon-skills" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                                <g id="SVGRepo_tracerCarrier" strokeLinecap="round" strokeLinejoin="round"></g>
