        ...
        <div>
            <main>
                <section className=" h-100 relative z-0 bg-[url(../../public/media/backgrounds/head-lightgreen-XL-desktop.svg)] bg-bottom bg-no-repeat bg-cover">
                    ...
                    <p className="flex justify-center">Création d'un clip musical en stop motion pour l'artiste Quentin</p>
                    <p className="flex justify-center">PremierePro</p>
                </section>
                
                <section className="wrapper flex flex-col -mt-60 relative z-1">
                    <div className="mockup h-150 bg-[url(../../public/media/projets/mockupNSDesktop.png)] bg-contain bg-center bg-no-repeat"></div>
                    ...
                    <div className="content">
                        ...
                        <img src="../../media/projets/NS-1.png"/>
                        ...
                        <img src="../../media/projets/NS-2.png"/>
