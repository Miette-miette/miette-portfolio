    ...
    return (
        <main>
            <section className="bg-[url(../../public/media/backgrounds/head-pink.svg)] pt-20 md:pt-25 bg-bottom bg-no-repeat bg-cover text-amber-50 text-center pb-26">
                <h1 className="flex justify-center p-6 mb-5 text-3xl md:text-4xl bg-[url(../../public/media/button/button-xxl.svg)] bg-center bg-no-repeat bg-contain text-[#B36E7B]">Design Graphique & Illustration</h1> 
